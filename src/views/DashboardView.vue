...
<template>
  <div class="py-6 sm:py-8 md:py-8 md:py-16 min-h-[60vh]">
    <div class="container max-w-[720px] mx-auto w-full">
      <header class="mb-6 sm:mb-8">
        <h1 class="m-0 mb-2 text-2xl sm:text-[1.65rem] md:text-[1.75rem] font-bold">Salut {{ displayName || 'toi' }}</h1>
        <p class="m-0 text-[var(--text-muted)] text-base sm:text-lg leading-relaxed">
          Bienvenue sur ton tableau de bord Kortex AI. Tu peux gérer ton espace et accéder à tes outils depuis ici.
        </p>
      </header>

      <div class="grid grid-cols-1 min-[600px]:grid-cols-2 gap-6">
